...
//   const [history, setHistory] = useState([]); // For storing the chat history
...
//       if (response.ok) {
//         setHistory([...history, { query, answer: data.answer }]); // Append query and answer to history
...
//           <Box className="my-4" style={{ maxHeight: '400px', overflowY: 'auto' }}>
...
//           {/* Optional: Display the sources of the latest search */}
//           {sources.length > 0 && (
//             <div className="mt-4">
